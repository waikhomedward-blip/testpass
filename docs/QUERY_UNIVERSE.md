...
- Source: r/ROGAlly, two threads (Nov/Dec 2026 per brief); Nintendo Switch is TestPass's own
  MODEL-DEPENDENT category with the identical calibration-screen primitive
